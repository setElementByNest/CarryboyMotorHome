    ...
    return (
        <section className="footer">
            <div className="footermain">
                <div className="costomer" style={{display: 'none'}}>
                ...
                <div className="realfoot">
                    <div className="foot_1">
                        <div className="foot_1A">
                            ...
                            <h3 style={{ marginRight: '25px' }}>Tel : <a href="tel:02-752-8585" ><u style={{ cursor: 'pointer', color: '#222222' }}>02-752-8585</u></a></h3>
                            <h3 style={{ marginRight: '25px' }}>Email : <a href="mailto:grand@carryboy.com?subject=ติดต่อสอบถามจากลูกค้าMotorHome"><u style={{ cursor: 'pointer', color: '#222222' }}>grand@carryboy.com</u></a></h3>
                            <h3>Line id : <a href="https://line.me/R/ti/p/%40127eomim" target="_blank" ><u style={{ cursor: 'pointer', color: '#222222' }}>@cargobox</u></a></h3>
                            <div style={{ display: 'flex', flexDirection: 'row', height: '30px', width: '100%', mixBlendMode: 'difference' }}>
                                <a href="https://www.facebook.com/CarryboyClub/" target="_blank" className="logocontact" >
                                    <div>
                                        <img src="/img_videopage/icon_contact_facebook.png" alt="" width={25} height={25} />
                                    </div>
                                </a>
                                <a href="https://www.youtube.com/user/CARRYBOYONLINE" target="_blank" className="logocontact" >
                                    <div>
                                        <img src="/img_videopage/icon_contact_youtube.png" alt="" width={25} height={25} />
                                    </div>
                                </a>
                                <a href="https://www.instagram.com/carryboy_official_thailand/" target="_blank" className="logocontact" >
                                    <div>
                                        <img src="/img_videopage/icon_contact_instagram.png" alt="" width={25} height={25} />
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div className="foot_1B">
                            ...
                            <img src="/img_videopage/M_127eomim_GW.png" alt="" className="qrline_img" onClick={qimg_click} />
                        </div>
                    </div>
                    <div className="foot_2">
                        <div className="foot_2A">
                            <div className="foot_2A_Logo"></div>
                            <a style={{textDecoration: 'none', color: '#666666'}} href="https://carryboycaravan.com/motorhome/">CARRYBOY MOTORHOME</a>
                        </div>
