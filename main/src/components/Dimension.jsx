            ...
            <div className='dimension-content'>
                ...
                <div className='dimension-select'>
                    ...
                    <div className='dimension-chooseselect'>
                        <div onClick={() => {dimensionSet('#cc0000', '#cccccc', '#cccccc', '#cccccc','carryboy-motorhome-rv-Plan01_0.jpg')}} className='dimension-select-text' id='dimension-select-1'>Pattern 1</div>
                        <div onClick={() => {dimensionSet('#cccccc', '#cc0000', '#cccccc', '#cccccc','carryboy-motorhome-rv-Plan02_0.jpg')}} className='dimension-select-text' id='dimension-select-2'>Pattern 2</div>
                        <div onClick={() => {dimensionSet('#cccccc', '#cccccc', '#cc0000', '#cccccc','carryboy-motorhome-rv-Plan03_0.jpg')}} className='dimension-select-text' id='dimension-select-3'>Pattern 3</div>
                        <div onClick={() => {dimensionSet('#cccccc', '#cccccc','#cccccc', '#cc0000', 'carryboy-motorhome-rv-dimension.jpg')}} className='dimension-select-text' id='dimension-select-4'>Dimension</div>
                    </div>
                </div>
            </div>
        </div>
