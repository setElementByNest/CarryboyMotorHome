        ...
        <div className="option">
            <div className="optionmain">
                <div className="optionsub_1">
                    <h2 style={{fontFamily: 'Kanit', fontWeight: '400'}}>ตัวเลือกเพิ่มเติม</h2>
                </div>
                        ...
                        <div className="optionsub_2_group opimg1" onClick={() => clickpop('option', 'suspension')}>
                            <div className="gradientopimg">
                                ...
                                <div style={{
                                    fontSize: '12px',
                                    marginBottom: '20px'
                                }}><div className="u_naja">ข้อมูลเพิ่มเติม<div className="fa fa-angle-right" style={{ marginLeft: '10px' }}></div></div></div>
                            </div>
                        </div>
