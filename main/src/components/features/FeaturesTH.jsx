    ...
    <div className='ft' id='ft'>
      <div className='ft_show'>
        ...
        <div className='ft_show-choose'>
          <h2 style={{fontFamily: 'Kanit', fontWeight: '400'}}>คุณสมบัติ</h2>

          <div className='ftchoose-n' id='ftchoose1' onClick={(event) => { clickshange(event, 1, 'carryboy-motorhome-rv-interior-skyview-open.jpg') }}>หลังคา Skyview</div>
          <div className='ftchoose-n' id='ftchoose2' onClick={(event) => { clickshange(event, 2, 'carryboy-motorhome-rv-interior-aircondition-1.jpg') }}>เครื่องปรับอากาศ</div>
          <div className='ftchoose-n' id='ftchoose3' onClick={(event) => { clickshange(event, 3, 'carryboy-motorhome-rv-exterior-solar.jpg') }}>แผงโซล่าเซลล์</div>
          <div className='ftchoose-n' id='ftchoose4' onClick={(event) => { clickshange(event, 4, 'carryboy-motorhome-rv-interior-monitor.jpg') }}>กล้อง 360°</div>
