...
function Features() {
  function clickshange(event, n, namefile) {
    for (let i = 1; i < 8; i++) {
      document.getElementById('ftchoose' + i).style.borderBottom = '#aaaaaa solid 1px';
      document.getElementById('ftchoose' + i).style.padding = '2px 5px 2px';
    }
    for (let i = 1; i < 5; i++) {
    ...
    event.target.style.borderBottom = '#cc0000 solid 2px';
    event.target.style.padding = '2px 5px 1px';
  ...
  function hideShow() {
    ...
    if (document.getElementById('ftshowimglistbt').innerHTML == 'Hide Items') {
      document.getElementById('ftshowimglistbt').innerHTML = 'Show Items';
      ...
      document.getElementById('ftshowimglistbt').innerHTML = 'Hide Items';
    ...
    <div className='ft' id='ft'>
      <div className='ft_show'>
        ...
        <div className='ft_show-img' id='ftshowimg'>
          <video controls autoPlay loop muted id='videoTag'>
            <source src="" type="video/mp4" />
          </video>
          <div className='ft_show-img-list-bt' id='ftshowimglistbt' onClick={hideShow}>Hide Items</div>
        ...
        <div className='ft_show-choose'>
          ...
          <div style={{border: 'none'}}>
            ...
            <div className='ftchoose-n' id='ftchoose5' onClick={(event) => { clickshange(event, 5, 'carryboy-motorhome-rv-exterior-awning-video.mp4') }}>Electric Awning</div>
            <div className='ftchoose-n' id='ftchoose6' onClick={(event) => { clickshange(event, 6, 'carryboy-motorhome-rv-exterior-ladder-video.mp4') }}>Electric Ladder</div>
            <div className='ftchoose-n' id='ftchoose7' onClick={(event) => { clickshange(event, 7, 'carryboy-motorhome-rv-feature-generator.jpg') }}>Generator 3 kW.</div>
          </div>
