            ...
            <div className='interior2-content'>
                ...
                <div className='interior2-img'  style={{backgroundImage: nameImg[nowPage - 1]}}>
                    <div className="interior2-showlist" style={{
                        ...
                        <div className='interior2-img-pinbt' onClick={() => {setShow(false); setNowPageImg(1)}}>Close</div>
                    ...
                    <div className='interior2-img-pinbt' style={{display: now3D ? "none" : "flex"}} onClick={() => {setHidePin(!nowHidePin)}}>{nowHidePin ? "Hide Pin" : "Show Pin"}</div>
