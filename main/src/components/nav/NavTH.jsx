        ...
        <div className="nav">
            <div className="nav-content">
                ...
                <div className="list_desktop">
                    <a title="Home" href='https://carryboymotorhome.com/'>หน้าแรก</a>
                    <a title="Video" href='https://carryboymotorhome.com/videopage.html'>วิดีโอแนะนำ</a>
                    <a title="Build your RV" href='https://carryboymotorhome.com/buildrv.html'>สั่งจองรถบ้าน</a>
                    <a title="gallery" href='https://carryboymotorhome.com/gallery.html'>คลังภาพ</a>
                    <a title="Contact" href='https://carryboymotorhome.com/contact.html'>ติดต่อ</a>
                    <Dropdown menu={{ items }} placement="bottomRight" arrow >
                        <a>โบรชัวร์</a>
                    </Dropdown>
                    <div title="Eng" className="nav-a-lang" onClick={() => { window.location.href = "/" }}>English</div>
                </div>
            ...
            <div className='navmobile' id='navmobile'>
                <a href='https://carryboymotorhome.com/' >หน้าแรก</a>
                <a href='https://carryboymotorhome.com/videopage.html'>วิดีโอแนะนำ</a>
                <a href='https://carryboymotorhome.com/buildrv.html' >สั่งจองรถบ้าน</a>
                <a href='https://carryboymotorhome.com/gallery.html'>คลังภาพ</a>
                <a href='https://carryboymotorhome.com/contact.html'>ติดต่อ</a>
