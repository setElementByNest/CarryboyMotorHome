                ...
                <div className="realfoot">
                    <div className="foot_1">
                        <div className="foot_1A">
                            <h2>Contact</h2>
                            <h3 style={{ fontWeight: '400' }}>Grand Carryboy Marketing Company Limited</h3>
                            {/* <h3 style={{ fontWeight: '400' }}>บริษัท แครี่บอย มาร์เก็ตติ้ง จำกัด (แกรนด์ แครี่บอย)</h3> */}
                            <h4>26/12 Village No. 7, Bangna-Trad Road, Bang Kaeo Subdistrict, Bang Phli District, Samut Prakan Province 10540</h4>
                        ...
                        <div className="foot_1B">
                            <a href="https://line.me/R/ti/p/%40127eomim" target="_blank" className="addfriend">Line QR code</a>
