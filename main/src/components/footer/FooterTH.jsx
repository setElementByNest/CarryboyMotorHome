                ...
                <div className="realfoot">
                    <div className="foot_1">
                        <div className="foot_1A">
                            ...
                            {/* <h3 style={{ fontWeight: '400' }}>บริษัท แครี่บอย มาร์เก็ตติ้ง จำกัด (แกรนด์ แครี่บอย)</h3> */}
                            <h4>26/12 หมู่ที่ 7 ถ.บางนา-ตราด ต.บางแก้ว อ.บางพลี จ.สมุทรปราการ 10540</h4>
                            {/* <h4>26/12 หมู่ที่ 7 ถ.บางนา-ตราด กม.8 (ขาออก) ตรงข้าม เมกา บางนา ต.บางแก้ว อ.บางพลี จ.สมุทรปราการ 10540</h4> */}
                            <h3 style={{ marginRight: '25px' }}>เบอร์โทร : <a href="tel:02-752-8585" ><u style={{ cursor: 'pointer', color: '#222222' }}>02-752-8585</u></a></h3>
                            <h3 style={{ marginRight: '25px' }}>อีเมล : <a href="mailto:grand@carryboy.com?subject=ติดต่อสอบถามจากลูกค้าMotorHome"><u style={{ cursor: 'pointer', color: '#222222' }}>grand@carryboy.com</u></a></h3>
