...
function selectmenu(n) {
  ...
  switch (n) {
    case 1:
      ...
      break;
    case 2:
      document.getElementById('bothcar-img-toyota').style.transform = 'translate(10%, -50%)';
      document.getElementById('bothcar-img-mitsubishi').style.transform = 'translate(100%, -40%)';
      ...
      break;
    case 3:
      document.getElementById('bothcar-img-toyota').style.transform = 'translate(150%, -50%)';
      document.getElementById('bothcar-img-mitsubishi').style.transform = 'translate(-40%, -50%)';
      document.getElementById('bothcar-detail-toyota').style.transform = 'translate(-50%, 0)';
      document.getElementById('bothcar-detail-toyota').style.opacity = '0';
  ...
  return (
    <div className='bothcar' id='bothcar'>
      <div className='bothcar-menu'>
        ...
        <h3 id='bothcar-menu2' onClick={() => { selectmenu(2) }}>TOYOTA</h3>
